/******/ (() => {
  ...
  \*****************************************/
      /***/ (
        ...
        /* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../../modules */ './src/modules/index.js');
        /* harmony import */ var _modules_PostListModule__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../../modules/PostListModule */ './src/modules/PostListModule.js',
          );
        ...
        const PostList = (itemList, done, state) => {
          const { value, datedSelector, pagenateSelector, authorFilter } =
            state;
          const pagenateList = [];
          let outputList = [];
          ...
          _modules__WEBPACK_IMPORTED_MODULE_0__.store.postList.dispatch(
            (0,
            _modules_PostListModule__WEBPACK_IMPORTED_MODULE_1__.pageLength)({
          ...
          const getPage = (list) => {
            if (!state.page) {
              ...
              _modules__WEBPACK_IMPORTED_MODULE_0__.store.postList.dispatch(
                (0,
                _modules_PostListModule__WEBPACK_IMPORTED_MODULE_1__.pageInit)(),
              );
  ...
  \*********************************************/
      /***/ (
        ...
        /* harmony import */ var _containers_SubmitButtonContainer__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../../containers/SubmitButtonContainer */ './src/containers/SubmitButtonContainer.js',
          );
        ...
        const WriteEditor = (Instance) => {
          return h(
            ...
            h(
              ...
              null,
              (0,
              _containers_SubmitButtonContainer__WEBPACK_IMPORTED_MODULE_0__[
                'default'
              ])(Instance),
            ),
          );
  ...
  \*****************************************/
      /***/ (
        ...
        /* harmony import */ var _components_common_header__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../components/common/header */ './src/components/common/header.js',
          );
        /* harmony import */ var _components_post_Post__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../components/post/Post */ './src/components/post/Post.js',
          );
        /* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../core/Component */ './src/core/Component.js',
          );
        /* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ../modules */ './src/modules/index.js');
        /* harmony import */ var _modules_PostModule__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ../modules/PostModule */ './src/modules/PostModule.js',
          );
        /** @jsx h */
        ...
        const compPost = new _core_Component__WEBPACK_IMPORTED_MODULE_2__[
          'default'
        ]();
        ...
        const PostContainer = () => {
          ...
          const dispatch =
            _modules__WEBPACK_IMPORTED_MODULE_3__.store.post.dispatch;
          ...
          async function getPost(postId) {
            try {
              const res = await fetch(
                `https://oceanvue-steven-yn.koyeb.app/${postId}`,
              );
              ...
              return dispatch(
                (0, _modules_PostModule__WEBPACK_IMPORTED_MODULE_4__.readPost)(
                  body,
                ),
              );
            } catch (error) {
          ...
          const onLoad = () => {
            if (getState().post) {
              ...
              compPost.render(
                (0,
                _components_post_Post__WEBPACK_IMPORTED_MODULE_1__['default'])(
                  setState.post,
                  true,
                ),
                $elem.PostWrap,
          ...
          return h(
            ...
            (0,
            _components_common_header__WEBPACK_IMPORTED_MODULE_0__[
              'default'
            ])(),
            h('div', {
              class: 'spacer',
  ...
  \*********************************************/
      /***/ (
        ...
        /* harmony import */ var _components_post_PostList__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../components/post/PostList */ './src/components/post/PostList.js',
          );
        /* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ../modules */ './src/modules/index.js');
        /* harmony import */ var _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../modules/PostListModule */ './src/modules/PostListModule.js',
          );
        /* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ../core/Component */ './src/core/Component.js',
          );
        ...
        const compPostList = new _core_Component__WEBPACK_IMPORTED_MODULE_3__[
          'default'
        ]();
        const clickEvent = () => {
          const $elem = {
          ...
          const dispatch =
            _modules__WEBPACK_IMPORTED_MODULE_1__.store.postList.dispatch;
          ...
          $elem.PostListBlock.onclick = (event) => {
            ...
            dispatch(
              _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.authorSelect(
                {
            ...
            compPostList.render(
              (0,
              _components_post_PostList__WEBPACK_IMPORTED_MODULE_0__[
                'default'
              ])(setState.postList, true, setState),
              $elem.PostListBlock,
            );
          };
        };
        ...
        const PostListContainer = (itemList, done) => {
          ...
          const onChangeField = (value) => {
            if (!value) {
              ...
              dispatch(
                _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.changeField(
                  value,
                ),
              );
            }
          ...
          const onLoad = () => {
            if (!itemList) {
              setState = getState();
              dispatch(
                _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.readPostList(
                  setState.postList,
                ),
              );
              compPostList.render(
          ...
          compPostList.oceanEffect(() => {
            ...
            const datedEvent = () => {
              $elem.datedSelector.onchange = () => {
                let selectorValue =
                  $elem.datedSelector.options[$elem.datedSelector.selectedIndex]
                    .value;
                dispatch(
                  _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.datedSelect(
                    {
            ...
            const pagenationEvent = () => {
              $elem.pagenateSelector.onchange = () => {
                let selectorValue =
                  $elem.pagenateSelector.options[
                    $elem.pagenateSelector.selectedIndex
                  ].value;
                dispatch(
                  _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.pagenationSelect(
                    {
                      selector: selectorValue,
                    },
                  ),
            ...
            const pageEvent = () => {
              $elem.prevPage.onclick = () => {
                if (getState().page === 1) {
                  ...
                  _modules__WEBPACK_IMPORTED_MODULE_1__.store.postList.dispatch(
                    _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.pageDecrease(),
                  );
                  setState = getState();
              ...
              $elem.nextPage.onclick = () => {
                ...
                if (getState().page >= pageLength) {
                  ...
                  _modules__WEBPACK_IMPORTED_MODULE_1__.store.postList.dispatch(
                    _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.pageIncrease(),
                  );
                  setState = getState();
            ...
            const defaultEvent = () => {
              $elem.defaultButton.onclick = () => {
                if (!itemList) {
                  dispatch(
                    _modules_PostListModule__WEBPACK_IMPORTED_MODULE_2__.refreshStore(
                      getState().postList,
                    ),
                  );
                } else {
                ...
                if (getState().postList) {
                  ...
                  if (!itemList) {
                    compPostList.render(
                      ...
                      _components_post_PostList__WEBPACK_IMPORTED_MODULE_0__[
                        'default'
                      ])(getState().postList, true, getState()),
                      $elem.PostListBlock,
                    );
                  } else {
                    compPostList.render(
            ...
            onLoad();
            _modules__WEBPACK_IMPORTED_MODULE_1__.store.postList.subscribe(
              onSetState,
            );
            changeEvent();
            searchEvent();
          ...
          if (!itemList) {
            return h(
              ...
              _components_post_PostList__WEBPACK_IMPORTED_MODULE_0__[
                'default'
              ])(setState.postList, done, setState),
            );
          } else {
            return h(
              'div',
  ...
  \*************************************************/
      /***/ (
        ...
        /* harmony import */ var _components_write_submitButton__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../components/write/submitButton */ './src/components/write/submitButton.js',
          );
        /* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ../modules */ './src/modules/index.js');
        /* harmony import */ var _modules_writeModule__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../modules/writeModule */ './src/modules/writeModule.js',
          );
        ...
        const SubmitButtonContainer = (Instance) => {
          ...
          const dispatch =
            _modules__WEBPACK_IMPORTED_MODULE_1__.store.editor.dispatch;
          ...
          const onPublish = (payload) => {
            if (!payload) {
              ...
              dispatch(
                _modules_writeModule__WEBPACK_IMPORTED_MODULE_2__.updatePost(
                  payload,
                ),
              );
            } else {
              ...
              dispatch(
                _modules_writeModule__WEBPACK_IMPORTED_MODULE_2__.writePost({
                  title,
                  author,
                  body,
                }),
          ...
          Instance.oceanEffect(() => {
            ...
            async function postUpdate(state) {
              try {
                const res = await fetch(
                  `https://oceanvue-steven-yn.koyeb.app/${state.postId}`,
                  {
                    method: 'PATCH',
                    headers: {
                      'content-Type': 'application/json',
            ...
            _modules__WEBPACK_IMPORTED_MODULE_1__.store.editor.subscribe(
              onPublish,
            );
            clickEvent();
          ...
          return h(
            ...
            (0,
            _components_write_submitButton__WEBPACK_IMPORTED_MODULE_0__[
              'default'
            ])(),
          );
        };
  ...
  \************************************************/
      /***/ (
        ...
        /* harmony import */ var _components_write_WriteEditor__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ../components/write/WriteEditor */ './src/components/write/WriteEditor.js',
          );
        /* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ../core/Component */ './src/core/Component.js',
        ...
        /* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! ../modules */ './src/modules/index.js');
        /* harmony import */ var _modules_writeModule__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ../modules/writeModule */ './src/modules/writeModule.js',
          );
        ...
        const compWrite = new _core_Component__WEBPACK_IMPORTED_MODULE_2__[
          'default'
        ]();
        ...
        const WriteEditorContainer = () => {
          ...
          const dispatch =
            _modules__WEBPACK_IMPORTED_MODULE_3__.store.editor.dispatch;
          const mount =
            _modules_writeModule__WEBPACK_IMPORTED_MODULE_4__.initialize;
          const hashPath = window.location.hash.replace('#', '');
          ...
          const onChangeField = (payload) => {
            if (!payload) {
              ...
              dispatch(
                _modules_writeModule__WEBPACK_IMPORTED_MODULE_4__.changeField(
                  payload,
                ),
              );
            }
          ...
          compWrite.oceanEffect(() => {
            if (hashPath === 'update') {
              if (onFix()) {
                dispatch(
                  _modules_writeModule__WEBPACK_IMPORTED_MODULE_4__.setOriginalPost(
                    onFix(),
                  ),
                );
              }
            ...
            _modules__WEBPACK_IMPORTED_MODULE_3__.store.editor.subscribe(
              onChangeField,
            );
            changeEvent();
          ...
          return h(
            ...
            h(
              ...
              (0,
              _components_write_WriteEditor__WEBPACK_IMPORTED_MODULE_1__[
                'default'
              ])(compWrite),
            ),
          );
  ...
  \*******************************/
      /***/ (
        ...
        /* harmony import */ var _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ../containers/PostListContainer */ './src/containers/PostListContainer.js',
          );
          ...
          Component.prototype.router = function (entryInstance) {
            const router = function () {
              ...
              if (isNum) {
                ...
                try {
                  const uiComponent =
                    _routes.find((route) => route.path === hashPath)
                      .component || '';
                  ...
                  if (hashPath === '') {
                    if (setBody.length > 0) {
                      (0,
                      _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_0__[
                        'default'
                      ])(setBody, true);
                    }
                  }
          ...
          Component.prototype.getPostList = async function () {
            try {
              ...
              if (body) {
                ...
                _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_0__[
                  'default'
                ])(body, res.ok); // 배열 스택에 저장

                setBody = body; // PostList가 재 렌더링 된후 엘리먼트가 있을때 add 이벤트

                this.compDidMount(
                  _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_0__.clickEvent,
                );
              }
            } catch (error) {
              return alert(error);
...
*/
  ...
  \***************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ pagenationSelect: () =>
            /* binding */ pagenationSelect,
        ...
        const authorSelect = ({ value }) => ({
          type: AUTHOR_FILTER,
          value,
        });
        const datedSelect = ({ selector }) => ({
          type: DATED_SELECT,
          selector,
        });
        const pagenationSelect = ({ selector }) => ({
        ...
        function postListModule(state = initialState, action = {}) {
          switch (action.type) {
            ...
            case AUTHOR_FILTER:
              return { ...state, authorFilter: action.value };

            case DATED_SELECT:
              return { ...state, datedSelector: action.selector };

            case PAGENATE_SECLET:
              return { ...state, pagenateSelector: action.selector };

            case REFRESH_STORE:
              return { ...initialState, postList: action.payload };

            case PAGE_INCREASE:
              return { ...state, page: state.page + state.diff };

            case PAGE_DECREASE:
              return { ...state, page: state.page - state.diff };

            case PAGE_LENGTH:
              return { ...state, pageLength: action.number };
  ...
  \******************************/
      /***/ (
        ...
        /* harmony import */ var _core_Store__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ../core/Store */ './src/core/Store.js');
        /* harmony import */ var _PostListModule__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./PostListModule */ './src/modules/PostListModule.js',
          );
        /* harmony import */ var _PostModule__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./PostModule */ './src/modules/PostModule.js',
          );
        /* harmony import */ var _writeModule__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./writeModule */ './src/modules/writeModule.js',
          );

        const store = {
          postList: (0, _core_Store__WEBPACK_IMPORTED_MODULE_0__.createStore)(
            _PostListModule__WEBPACK_IMPORTED_MODULE_1__['default'],
          ),
          editor: (0, _core_Store__WEBPACK_IMPORTED_MODULE_0__.createStore)(
            _writeModule__WEBPACK_IMPORTED_MODULE_3__['default'],
          ),
          post: (0, _core_Store__WEBPACK_IMPORTED_MODULE_0__.createStore)(
            _PostModule__WEBPACK_IMPORTED_MODULE_2__['default'],
          ),
        };
  ...
  \************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          ...
          /* harmony export */ setOriginalPost: () =>
            /* binding */ setOriginalPost,
        ...
        const writePost = ({ title, author, body }) => ({
          type: WRITE_POST,
          payload: {
            title,
            author,
        ...
        const updatePost = ({ postId, title, author, body }) => ({
          type: UPDATE_POST,
          payload: {
            postId,
            title,
  ...
  \******************************************************************/
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ['webpack://./src/css/Header.css'],
            names: [],
            mappings:
              'AAAA;EACE,eAAe;EACf,WAAW;EACX,2CAA2C;EAC3C,UAAU;;EAEV,YAAY;EACZ,mBAAmB;EACnB,kBAAkB;EAClB,mBAAmB;EACnB,WAAW;EACX,cAAc;EACd,YAAY;EACZ,aAAa;EACb,mBAAmB;EACnB,8BAA8B;AAChC;;AAEA;EACE,mBAAmB;EACnB,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd',
            sourcesContent: [
              'header {\r\n  position: fixed;\r\n  width: 100%;\r\n  box-shadow: 0px 2px 4px rgba(0, 0, 0, 0.08);\r\n  z-index: 5;\r\n\r\n  color: white;\r\n  background: #3b85c2;\r\n  padding-left: 3rem;\r\n  padding-right: 3rem;\r\n  width: 100%;\r\n  margin: 0 auto;\r\n  height: 6rem;\r\n  display: flex;\r\n  align-items: center;\r\n  justify-content: space-between;\r\n}\r\n\r\n.logo {\r\n  font-size: 1.125rem;\r\n  font-weight: 800;\r\n  letter-spacing: 1px;\r\n}\r\n\r\n.logo a {\r\n  color: white;\r\n}\r\n',
            ],
            sourceRoot: '',
  ...
  \****************************************************************/
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ['webpack://./src/css/Post.css'],
            names: [],
            mappings:
              'AAAA;EACE,8BAA8B;EAC9B,uBAAuB;AACzB;;AAEA;EACE,wBAAwB;EACxB,oBAAoB;EACpB,mBAAmB;AACrB;;AAEA;EACE,eAAe;EACf,oBAAoB;AACtB',
            sourcesContent: [
              '#PostBlock {\r\n  padding: 2rem 2rem 0.5rem 2rem;\r\n  background-color: white;\r\n}\r\n\r\n#PostHead {\r\n  border-bottom: 1px solid;\r\n  padding-bottom: 3rem;\r\n  margin-bottom: 3rem;\r\n}\r\n\r\n#PostContent {\r\n  font-size: 1rem;\r\n  padding-bottom: 2rem;\r\n}\r\n',
            ],
            sourceRoot: '',
  ...
  \********************************************************************/
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ['webpack://./src/css/PostList.css'],
            names: [],
            mappings:
              'AAAA;EACE,iBAAiB;EACjB,oBAAoB;AACtB;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,2BAA2B;EAC3B,kBAAkB;EAClB,mBAAmB;AACrB;;AAEA;EACE,qBAAqB;EACrB,aAAa;AACf;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,eAAe;EACf,oBAAoB;AACtB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,iBAAiB;EACjB,mBAAmB;EACnB,8BAA8B;EAC9B,uBAAuB;AACzB;;AAEA;EACE,YAAY;EACZ,YAAY;AACd;;AAEA;EACE,iBAAiB;AACnB;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,aAAa;EACb,mBAAmB;EACnB,6BAA6B;EAC7B,mBAAmB;AACrB',
            sourcesContent: [
              '#PostItemBlock {\r\n  padding-top: 1rem;\r\n  padding-bottom: 1rem;\r\n}\r\n\r\n#PostItem:first-child {\r\n  padding-top: 0;\r\n}\r\n\r\n#PostItem + #PostItem {\r\n  border-top: 1px solid black;\r\n  margin-top: 0.5rem;\r\n  padding-top: 0.5rem;\r\n}\r\n\r\n#PostItem h3 {\r\n  margin-bottom: 0.5rem;\r\n  margin-top: 0;\r\n}\r\n\r\n#PostItem h2:hover {\r\n  color: #555555;\r\n}\r\n\r\n#PostItem span {\r\n  font-size: 15px;\r\n  margin-right: 0.5rem;\r\n}\r\n\r\n#PostItem p span {\r\n  margin-left: 0.5rem;\r\n}\r\n\r\n#PostListBlock {\r\n  margin-top: 10rem;\r\n  margin-bottom: 2rem;\r\n  padding: 2rem 2rem 0.5rem 2rem;\r\n  background-color: white;\r\n}\r\n\r\n#searchBar {\r\n  width: 15rem;\r\n  height: 2rem;\r\n}\r\n\r\n#searchButton {\r\n  margin-left: 1rem;\r\n}\r\n\r\n.authorTag:hover {\r\n  cursor: pointer;\r\n}\r\n\r\n#pageBtnWrap {\r\n  display: flex;\r\n  flex-direction: row;\r\n  justify-content: space-evenly;\r\n  align-items: center;\r\n}\r\n',
            ],
            sourceRoot: '',
  ...
  \******************************************************************/
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        ___CSS_LOADER_EXPORT___.push([
          ...
          {
            version: 3,
            sources: ['webpack://./src/css/button.css'],
            names: [],
            mappings:
              'AAAA;EACE,YAAY;EACZ,kBAAkB;EAClB,eAAe;EACf,iBAAiB;EACjB,qBAAqB;EACrB,YAAY;EACZ,aAAa;EACb,eAAe;EACf,4BAA4B;AAC9B;;AAEA;EACE,yBAAyB;AAC3B;;AAEA;EACE,gBAAgB;EAChB,mBAAmB;AACrB;;AAEA;EACE,mBAAmB;AACrB;;AAEA;EACE,YAAY;AACd',
            sourcesContent: [
              'button {\r\n  border: none;\r\n  border-radius: 4px;\r\n  font-size: 1rem;\r\n  font-weight: bold;\r\n  padding: 0.25rem 1rem;\r\n  color: white;\r\n  outline: none;\r\n  cursor: pointer;\r\n  background: rgb(22, 96, 165);\r\n}\r\n\r\nbutton + button {\r\n  margin: 0 0.5rem 0 0.5rem;\r\n}\r\n\r\n#submitButtonBlock {\r\n  margin-top: 1rem;\r\n  margin-bottom: 3rem;\r\n}\r\n\r\n#submitButtonBlock + #submitButtonBlock {\r\n  margin-left: 0.5rem;\r\n}\r\n\r\nbutton a {\r\n  color: white;\r\n}\r\n',
            ],
            sourceRoot: '',
  ...
  \****************************************************************/
      /***/ (module, __webpack_exports__, __webpack_require__) => {
        ...
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_Header_css__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./Header.css */ './node_modules/css-loader/dist/cjs.js!./src/css/Header.css',
          );
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_top_css__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./top.css */ './node_modules/css-loader/dist/cjs.js!./src/css/top.css',
          );
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_PostList_css__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./PostList.css */ './node_modules/css-loader/dist/cjs.js!./src/css/PostList.css',
          );
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_Post_css__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./Post.css */ './node_modules/css-loader/dist/cjs.js!./src/css/Post.css',
          );
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_Write_css__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./Write.css */ './node_modules/css-loader/dist/cjs.js!./src/css/Write.css',
          );
        /* harmony import */ var _node_modules_css_loader_dist_cjs_js_button_css__WEBPACK_IMPORTED_MODULE_7__ =
          __webpack_require__(
            /*! -!../../node_modules/css-loader/dist/cjs.js!./button.css */ './node_modules/css-loader/dist/cjs.js!./src/css/button.css',
          );
        // Imports
        ...
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_Header_css__WEBPACK_IMPORTED_MODULE_2__[
            'default'
          ],
        );
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_top_css__WEBPACK_IMPORTED_MODULE_3__[
            'default'
          ],
        );
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_PostList_css__WEBPACK_IMPORTED_MODULE_4__[
            'default'
          ],
        );
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_Post_css__WEBPACK_IMPORTED_MODULE_5__[
            'default'
          ],
        );
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_Write_css__WEBPACK_IMPORTED_MODULE_6__[
            'default'
          ],
        );
        ___CSS_LOADER_EXPORT___.i(
          _node_modules_css_loader_dist_cjs_js_button_css__WEBPACK_IMPORTED_MODULE_7__[
            'default'
          ],
        );
        // Module
        ___CSS_LOADER_EXPORT___.push([
          ...
          '',
          {
            ...
            names: [],
            mappings:
              'AAAA,gBAAgB;;AAShB;EACE,mBAAmB;EACnB,gBAAgB;EAChB,qBAAqB;AACvB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,UAAU;EACV,SAAS;EACT,sBAAsB,EAAE,wCAAwC;EAChE,gBAAgB;EAChB,yBAAyB;AAC3B;;AAEA;EACE,cAAc;AAChB;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,YAAY;AACd;;AAEA;EACE,kBAAkB;EAClB,mBAAmB;EACnB,aAAa;EACb,cAAc;AAChB;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,aAAa;EACb,uBAAuB;AACzB',
            sourcesContent: [
...
*/
  ...
  \********************/
    ...
    /* harmony import */ var _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./containers/PostListContainer */ './src/containers/PostListContainer.js',
      );
    /* harmony import */ var _containers_WriteEditorContainer__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(
        /*! ./containers/WriteEditorContainer */ './src/containers/WriteEditorContainer.js',
      );
    /* harmony import */ var _containers_PostContainer__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ./containers/PostContainer */ './src/containers/PostContainer.js',
      );
    /* harmony import */ var _core_Component__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ./core/Component */ './src/core/Component.js');
    /* harmony import */ var _components_common_NotFound__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(
        /*! ./components/common/NotFound */ './src/components/common/NotFound.js',
      );
    ...
    const App = () => {
      return h(
        ...
        (0,
        _components_common_header__WEBPACK_IMPORTED_MODULE_0__['default'])(),
        h('div', {
          class: 'spacer',
        }),
        h(
          ...
          (0,
          _containers_PostListContainer__WEBPACK_IMPORTED_MODULE_1__[
            'default'
          ])(),
        ),
      );
    ...
    const routes = [
      ...
      },
      {
        path: 'write',
        component:
          _containers_WriteEditorContainer__WEBPACK_IMPORTED_MODULE_2__[
            'default'
          ],
      },
      {
        path: ':postId',
        component:
          _containers_PostContainer__WEBPACK_IMPORTED_MODULE_3__['default'],
      },
      {
        path: 'update',
        component:
      ...
      },
      {
        path: 'error',
        component:
          _components_common_NotFound__WEBPACK_IMPORTED_MODULE_5__['default'],
      },
    ];
